        ...
        <div class="container">
            ...
            <div class="footer">
                <div class="footer_logo">
                    <div class="navbar">
                        <a class="navbar_brand logo" href="#">
                ...
                <div class="footer_wrapper">
                        ...
                        <div class="footer_item">
                            ...
                            <div class="footer_list">
                                <ul>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">Products</a></li>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">CookieYes</a></li>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">Webtofee</a></li>
                        ...
                        <div class="footer_item">
                            ...
                            <div class="footer_list">
                                <ul>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">About</a></li>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">About us</a></li>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">Career</a></li>
                                    <li class="footer_list_item"><a href= "" class = "footer_link">Contact</a></li>  
            ...
            <div class="footer_bottom">
                <div class="copy">
                    <span class="copy_img"><img src="<?php bloginfo('template_url');?>./assets/images/copy.png" alt=""></span>
                    <span class="copy_text">2022, All rights reserved.</span>
